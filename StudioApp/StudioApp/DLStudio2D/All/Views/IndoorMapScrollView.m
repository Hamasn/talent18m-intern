...
#define kPop_width          15.0f
#define kPop_height         15.0f
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _mapViewNew = [[IndoorMapViewNew alloc] initWithFrame:CGRectMake(0, 0, MRScreenHeight/2855*2000, MRScreenHeight)];
...
- (void)scrollViewDidZoom:(UIScrollView *)scrollView{
    ...
    NSDictionary *dict=[NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"%f",scrollView.zoomScale] ,@"zoomScale", nil];
    [center postNotificationName:@"Zoom" object:self userInfo:dict];
}
- (void)scrollViewDidEndZooming:(UIScrollView *)scrollView withView:(UIView *)view atScale:(CGFloat)scale
{
    NSNotificationCenter * center = [NSNotificationCenter defaultCenter];
    NSDictionary *dict=[NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"%f",scale] ,@"zoomScale", nil];
    [center postNotificationName:@"Zoom" object:self userInfo:dict];
}
...
- (void)handleDoubleTap:(UIGestureRecognizer *)gesture
{
    ...
    popover.center = CGPointMake(popover.center.x * newScale, popover.center.y * newScale );
}
...
//    CGFloat scale = (self.zoomScale / self.minimumZoomScale);
    ...
    CGFloat x_ratio = MRScreenHeight/2855;

    CGFloat y_ratio = MRScreenHeight/2855;
    popover.center = CGPointMake(position.point.x * x_ratio, position.point.y * y_ratio );
